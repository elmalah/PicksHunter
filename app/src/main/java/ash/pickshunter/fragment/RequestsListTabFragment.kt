 ...
 */
class RequestsListTabFragment(_orderStatusId: Int) : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private var orderStatusId = _orderStatusId
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_requests_list_tab, container, false)
    }
    ...
    fun loadData() {
        val adapter = RequestAdapter(arrayListOf(), ::onClickListener)
