...
class MyProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val fragmentAdapter = MyProfileTabAdapter(childFragmentManager)
        viewpager_my_profile.adapter = fragmentAdapter

        tabs_my_profile.setupWithViewPager(viewpager_my_profile)

        tabs_my_profile.getTabAt(0)!!.setIcon(R.drawable.followersactive)
        tabs_my_profile.getTabAt(1)!!.setIcon(R.drawable.tripsactive)
        tabs_my_profile.getTabAt(2)!!.setIcon(R.drawable.productsactive)
    }
