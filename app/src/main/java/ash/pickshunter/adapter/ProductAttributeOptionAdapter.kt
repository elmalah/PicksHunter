...
class ProductAttributeOptionAdapter(
    var options: List<ProductAttributeOption>,
    val onClickListener: (ProductAttributeOption, Int, Int) -> Unit,
    var pos: Int
) :
    RecyclerView.Adapter<ProductAttributeOptionAdapter.OptionViewHolder>() {

    fun notifyChange(options: List<ProductAttributeOption>) {
