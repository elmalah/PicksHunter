...
//    ): Call<ArrayList<Airport>>
    ...
    @Headers("Content-Type: application/x-www-form-urlencoded", "Authorization: bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..N-g4uaOYTGWfO6-0JlX4WDBjn_z7qbKEGgZRozl2LyeUUXJH7ezEzzP04jY7lzeMU0tlRdlZIZ8vR_1aAiCT6YspseZ90KgZtSaDl2cDcoH76mNQJMqmFA3DVcAVKu0xW7ZaekIN2mKGBxT2RXZ9oZZocJXMnE7dC7J0YqC8a_Oy8yVNthmT2YeJXip8m9LEasRDgtmuX7bLChTRd8G26qPI6tFOkydBZelOvt1DUFbSSpspPfJpHr0ynnigDXJekGTg1mgEUnInIVXBM5n4OaDoEtEj5GulgnkRrPE52PrFXWhdCgBtEOY2S-ENw-z_TZuFwgUljAG6BVsZ7sqU8g")
    ...
    fun checkIn(@Path("tripId") tripId: String, @Path("storeId") storeId: String
    ): Call<ResponseBody>

    @Headers("Content-Type: application/x-www-form-urlencoded", "Authorization: bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..N-g4uaOYTGWfO6-0JlX4WDBjn_z7qbKEGgZRozl2LyeUUXJH7ezEzzP04jY7lzeMU0tlRdlZIZ8vR_1aAiCT6YspseZ90KgZtSaDl2cDcoH76mNQJMqmFA3DVcAVKu0xW7ZaekIN2mKGBxT2RXZ9oZZocJXMnE7dC7J0YqC8a_Oy8yVNthmT2YeJXip8m9LEasRDgtmuX7bLChTRd8G26qPI6tFOkydBZelOvt1DUFbSSpspPfJpHr0ynnigDXJekGTg1mgEUnInIVXBM5n4OaDoEtEj5GulgnkRrPE52PrFXWhdCgBtEOY2S-ENw-z_TZuFwgUljAG6BVsZ7sqU8g")
    @GET("api/categories/{id}/attributes")
    fun getAttributes(@Path("id") id: String
    ): Call<AttributeResponse>

    @Headers("Content-Type: application/x-www-form-urlencoded", "Authorization: bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..N-g4uaOYTGWfO6-0JlX4WDBjn_z7qbKEGgZRozl2LyeUUXJH7ezEzzP04jY7lzeMU0tlRdlZIZ8vR_1aAiCT6YspseZ90KgZtSaDl2cDcoH76mNQJMqmFA3DVcAVKu0xW7ZaekIN2mKGBxT2RXZ9oZZocJXMnE7dC7J0YqC8a_Oy8yVNthmT2YeJXip8m9LEasRDgtmuX7bLChTRd8G26qPI6tFOkydBZelOvt1DUFbSSpspPfJpHr0ynnigDXJekGTg1mgEUnInIVXBM5n4OaDoEtEj5GulgnkRrPE52PrFXWhdCgBtEOY2S-ENw-z_TZuFwgUljAG6BVsZ7sqU8g")
    @POST("api/trip/check-out/{tripShopId}")
    fun checkOut(@Path("tripShopId") tripShopId: String
    ): Call<ResponseBody>

    @Headers("Content-Type: application/x-www-form-urlencoded", "Authorization: bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..N-g4uaOYTGWfO6-0JlX4WDBjn_z7qbKEGgZRozl2LyeUUXJH7ezEzzP04jY7lzeMU0tlRdlZIZ8vR_1aAiCT6YspseZ90KgZtSaDl2cDcoH76mNQJMqmFA3DVcAVKu0xW7ZaekIN2mKGBxT2RXZ9oZZocJXMnE7dC7J0YqC8a_Oy8yVNthmT2YeJXip8m9LEasRDgtmuX7bLChTRd8G26qPI6tFOkydBZelOvt1DUFbSSpspPfJpHr0ynnigDXJekGTg1mgEUnInIVXBM5n4OaDoEtEj5GulgnkRrPE52PrFXWhdCgBtEOY2S-ENw-z_TZuFwgUljAG6BVsZ7sqU8g")
    @GET("api/trip/shops/{id}")
    fun getTripShops(@Path("id") id: String
    ): Call<ArrayList<Shop>>
    ...
    fun resendVerificationCode(@Path("id") id: String
    ): Call<ApiResponse>

    @Headers("Content-Type: application/x-www-form-urlencoded", "Authorization: bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..N-g4uaOYTGWfO6-0JlX4WDBjn_z7qbKEGgZRozl2LyeUUXJH7ezEzzP04jY7lzeMU0tlRdlZIZ8vR_1aAiCT6YspseZ90KgZtSaDl2cDcoH76mNQJMqmFA3DVcAVKu0xW7ZaekIN2mKGBxT2RXZ9oZZocJXMnE7dC7J0YqC8a_Oy8yVNthmT2YeJXip8m9LEasRDgtmuX7bLChTRd8G26qPI6tFOkydBZelOvt1DUFbSSpspPfJpHr0ynnigDXJekGTg1mgEUnInIVXBM5n4OaDoEtEj5GulgnkRrPE52PrFXWhdCgBtEOY2S-ENw-z_TZuFwgUljAG6BVsZ7sqU8g")
    @POST("api/products/calculate-product-price")
    fun calculatePrice(@Body params : PriceRequest
    ): Call<PriceResponse>
    ...
    fun addComment(@Body params : ProductCommentRequest
    ): Call<Product>

    @Headers("Content-Type: application/x-www-form-urlencoded", "Authorization: bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..N-g4uaOYTGWfO6-0JlX4WDBjn_z7qbKEGgZRozl2LyeUUXJH7ezEzzP04jY7lzeMU0tlRdlZIZ8vR_1aAiCT6YspseZ90KgZtSaDl2cDcoH76mNQJMqmFA3DVcAVKu0xW7ZaekIN2mKGBxT2RXZ9oZZocJXMnE7dC7J0YqC8a_Oy8yVNthmT2YeJXip8m9LEasRDgtmuX7bLChTRd8G26qPI6tFOkydBZelOvt1DUFbSSpspPfJpHr0ynnigDXJekGTg1mgEUnInIVXBM5n4OaDoEtEj5GulgnkRrPE52PrFXWhdCgBtEOY2S-ENw-z_TZuFwgUljAG6BVsZ7sqU8g")
    @GET("api/trip/customer-trips/{id}")
    fun getTripDetails(@Path("id") id: Int, @Query("latest") isLatest: String
